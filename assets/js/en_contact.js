  ...
  newsletterForm.addEventListener("submit", function (event) {
    ...
    fetch("https://caret-u6dxo.ondigitalocean.app/api/newsletter/", {
      ...
      inputGroup.innerHTML =
        '<div style="width: 100%; padding: 0.9rem 1.2rem; color: white; font-size: 16px; font-weight: bold; text-align: center;">Thank you for subscribing!</div>';
    ...
    fetch("https://caret-u6dxo.ondigitalocean.app/api/contact/", {
      ...
      .then(() => {
        ...
        feedbackDiv.innerHTML =
          '<div style="color: #004225; font-family: "Montserrat", sans-serif;">Message sent. We will be in touch soon.</div>';
      ...
      .catch((error) => {
        // Show error message
        feedbackDiv.innerHTML =
          '<div style="color: #721c24; font-family: "Montserrat", sans-serif;">Oops! Something went wrong. Try again later.</div>';
